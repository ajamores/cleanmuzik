...
- **Filed tickets** — findings that earned a ticket number, one file each. Triaging one into a
  ...
  - [`T-219.md`](T-219.md) — **corroboration fast-path:** skip the LLM reconcile when the fingerprint identity already agrees with the source title *(2026-08-24, transplanted from muziktest's Confidence gate — fast-pathed 8/12 there; secondary to T-210, engine-touching, same acceptance bar as T-208)*
